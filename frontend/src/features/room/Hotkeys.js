...
export const Hotkeys = React.memo(({
    ...
    return(
        <Draggable>
        <div 
          className="insert-auto overflow-auto bg-gray-700 border max-w-lg rounded-lg outline-none text-white"
            style={{
            position:"absolute", 
            zIndex: 1e7, 
            right: "30px", 
                ...
                <tr className={"bg-gray-500"}>
                  ...
                  <td className="text-center">
                    <img 
                      ...
                      src={process.env.PUBLIC_URL + '/images/tokens/resource.png'}
                    />
                  </td>
                </tr>
                <tr className={"bg-gray-600"}>
                  ...
                  <td className="text-center">
                    <img 
                      className="m-auto h-6"
                      src={process.env.PUBLIC_URL + '/images/tokens/progress.png'}
                    />
                  </td>
                </tr>
                <tr className={"bg-gray-500"}>
                  ...
                  <td className="text-center">
                    <img 
                      className="m-auto h-6"
                      src={process.env.PUBLIC_URL + '/images/tokens/damage.png'}
                    />
                  </td>
                </tr>
                <tr className={"bg-gray-600"}>
                  ...
                  <td className="text-center">
                    <img 
                      className="m-auto h-6"
                      src={process.env.PUBLIC_URL + '/images/tokens/time.png'}
                    />
                  </td>
                </tr>
                <tr className={"bg-gray-500"}>
                  ...
                  <td className="text-center">
                    <img 
                      ...
                      src={process.env.PUBLIC_URL + '/images/tokens/willpower.png'}
                    />/ 
                    <img 
                      className="h-6 inline-block"
                      src={process.env.PUBLIC_URL + '/images/tokens/threat.png'}
                    />
                  </td>
                </tr>
                <tr className={"bg-gray-600"}>
                  ...
                  <td className="text-center">
                    <img 
                      className="m-auto h-6"
                      src={process.env.PUBLIC_URL + '/images/tokens/attack.png'}
                    />
                  </td>
                </tr>
                <tr className={"bg-gray-500"}>
                  ...
                  <td className="text-center">
                    <img 
                      className="m-auto h-6"
                      src={process.env.PUBLIC_URL + '/images/tokens/defense.png'}
                    />
                  </td>
                </tr>
                <tr className={"bg-gray-600"}>
                  ...
                  <td className="text-center">
                    <img 
                      className="m-auto h-6"
                      src={process.env.PUBLIC_URL + '/images/tokens/hitPoints.png'}
                    />
                  </td>
                </tr>
            </table>
