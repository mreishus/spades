...
export const Tokens = React.memo(({ 
    ...
    return(
        <div style={{width:'100%', height:'100%'}}>
            ...
            <Token tokenType="threat"    cardId={cardId} cardName={cardName} zIndex={zIndex} left={"55%"} top={"0%"}  showButtons={showButtons} gameBroadcast={gameBroadcast} chatBroadcast={chatBroadcast}></Token>
            <Token tokenType="willpower" cardId={cardId} cardName={cardName} zIndex={zIndex} left={"55%"} top={"25%"} showButtons={showButtons} gameBroadcast={gameBroadcast} chatBroadcast={chatBroadcast}></Token>
            <Token tokenType="attack"    cardId={cardId} cardName={cardName} zIndex={zIndex} left={"55%"} top={"50%"} showButtons={showButtons} gameBroadcast={gameBroadcast} chatBroadcast={chatBroadcast}></Token>
            <Token tokenType="defense"   cardId={cardId} cardName={cardName} zIndex={zIndex} left={"55%"} top={"75%"} showButtons={showButtons} gameBroadcast={gameBroadcast} chatBroadcast={chatBroadcast}></Token>
        </div>
    )
});