defmodule DragnCardsWeb.API.V1.ResetPasswordController do
  ...
  defp update_user(conn, user_params) do
    case Plug.update_user_password(conn, user_params) do
      ...
      {:error, changeset, conn} ->
        ...
        |> put_view(DragnCardsWeb.ChangesetView)
  ...
  defp confirmation_url(token) do
    Application.get_env(:dragncards, DragnCardsWeb.Endpoint)[:front_end_reset_password_url]
