defmodule SpadesGame.Groups do
  ...
  def new() do
    %{
      "gSharedQuestDeck"=>         Group.new("gSharedQuestDeck","Quest","deck","cShared"),
      ...
      "gSharedEncounterDeck3"=>    Group.new("gSharedEncounterDeck3","Encounter 3","deck","cShared"),
      "gSharedEncounterDiscard3"=> Group.new("gSharedEncounterDiscard3","Enc Discard 3","discard","cShared"),
